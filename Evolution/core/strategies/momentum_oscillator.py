...
class MomentumOscillatorStrategy():
    ...
    def __init__(self, params=None):
        ...
        self.long_window = params.get('long_window', 11)  # Slow moving average window
        self.min_samples = params.get('min_samples', max(self.long_window, 6))  # Minimum samples before making predictions
        self.overbought_threshold = params.get('overbought_threshold', 44)  # Threshold for overbought condition (0-100)
        self.oversold_threshold = params.get('oversold_threshold', 63)  # Threshold for oversold condition (0-100)
        self.signal_line_period = params.get('signal_line_period', 4)  # Period for signal line calculation
        self.reversal_weight = params.get('reversal_weight', 3.574285714285714)  # Weight for reversal signals (0-1)
        ...
        self.banker_bias = params.get('banker_bias', 0.13908163265306123)  # Slight bias towards banker bets
