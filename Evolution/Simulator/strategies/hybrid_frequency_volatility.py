...
class HybridFrequencyVolatilityStrategy(BaseStrategy):
    def __init__(self, simulator, params=None):
        super().__init__(simulator, params)
        
        # Initialize sub-strategies
        self.frequency_strategy = FrequencyAnalysisStrategy(simulator, params.get('frequency_params'))
        self.volatility_strategy = VolatilityAdaptiveStrategy(simulator, params.get('volatility_params'))
        
        # Performance tracking
        self.performance_window = params.get('performance_window', 50)
        ...
        self.min_confidence_diff = params.get('min_confidence_diff', 0.05)
        self.performance_weight = params.get('performance_weight', 0.3)
        self.confidence_weight = params.get('confidence_weight', 0.7)
