...
class NeuralOscillatorStrategy(BaseStrategy):
    """
    ...
    def __init__(self, simulator, params=None):
        ...
        self.coupling_strength = params.get('coupling_strength', 0.8818367346938776)
        self.adaptation_rate = params.get('adaptation_rate', 0.38326530612244897)
        self.resonance_threshold = params.get('resonance_threshold', 0.2142857142857143)
        self.phase_sync_threshold = params.get('phase_sync_threshold', 0.7040816326530612)
        self.min_samples = params.get('min_samples', 7)
        self.banker_bias = params.get('banker_bias', 0.021052631578947368)
